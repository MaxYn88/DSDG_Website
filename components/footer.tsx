        ...
        <div className="flex flex-col items-center gap-6 text-center">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent">
              <span className="text-lg font-bold text-accent-foreground">DS</span>
            </div>
          ...
          <p className="max-w-md text-sm text-primary-foreground/70">
            Data Science Discovery Group at the University of Illinois Urbana-Champaign.
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-primary-foreground/70">
            ...
            <Link href="/events" className="transition-colors hover:text-primary-foreground">
              Events
            </Link>
            <a
          ...
          <p className="text-xs text-primary-foreground/50">
            {new Date().getFullYear()} DSDG @ UIUC. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
